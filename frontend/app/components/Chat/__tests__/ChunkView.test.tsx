...
describe("ChunkView", () => {
  ...
  test("displays source and score information", () => {
    ...
    const sourceInfo = within(container).getByText("Source: test-document.pdf (Score: 0.8765)");
  ...
  test("handles chunk with empty content", () => {
    ...
    expect(within(wrapper).getByText("Source: test-document.pdf (Score: 0.8765)")).toBeInTheDocument();
  });
